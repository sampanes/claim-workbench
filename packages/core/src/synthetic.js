// Synthetic fixtures. Every example in this repository uses invented
// clients, codes, and portals; nothing here corresponds to a real claim.
...
export const syntheticPacket = {
  ...
  destination: {
    ...
    label: "Synthetic EAP Portal"
  },
  recipeId: "synthetic-eap-monthly",
  period: { start: "2026-06-01", end: "2026-06-30" },
  provenance: {
    importBatchId: "batch_synthetic_001",
