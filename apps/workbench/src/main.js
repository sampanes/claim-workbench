...
document.querySelector("#root").innerHTML = `
  <main class="desktop-shell">
    <section class="window" aria-label="Claim Workbench prototype">
      ...
      <div class="toolbar"><div><span class="eyebrow">Packet</span><strong>${syntheticPacket.id}</strong></div><div><span class="eyebrow">Destination</span><strong>${syntheticPacket.destination.label}</strong></div><div><span class="eyebrow">Next safe action</span><strong>Validate packet</strong></div></div>
